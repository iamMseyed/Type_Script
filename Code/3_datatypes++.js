...
var arr1 = [1, 2, 3, 4, 5]; //number array
//var arr2:number[]=[2,3,4,'a'];//error
var arrAny = [1, 4, 'a', "String"]; //should be any type
var arrCon = new Array(1, 2, 3, 4); //any type
...
var arrNew = []; //declaring and assigning of memory
arrNew[0] = 1;
arrNew[1] = 'a';
arrNew[2] = 0;
arrNew[3] = 'String';
var multipleValues = [1, "Nokia", 20000];
var id = multipleValues[0];
var brand = multipleValues[1];
var price = multipleValues[2];
var ID = multipleValues[0], BRAND = multipleValues[1], PRICE = multipleValues[2]; //take values directly called Array de-structing
var collection = [1, 'this', [1, 2, 3], function () { console.log("Hello"); }];
...
var tv = //this we need to implement at any cost, else it will throw error
 {
    ...
    Print: function () {
        console.log("Details of the product:\n            Name: ".concat(this.Name, ", \n            Price: ").concat(this.Total(), ";\n            Quantity: ").concat(this.Quantity, "\n            "));
    }
};
tv.Print();
//optional keys and values
var checking = //Age we don't necessarly need to implement, if we do, it will take if not, it won't through any error
 {
    Name: "Any Name",
    Print: function () {
...
var anyType = {
    ...
    Print: function () {
        console.log("\n                Source: ".concat(this.Source, "\n                Rating: Rated at: ").concat(this.Rating.Rate, ", Rated By:").concat(this.Rating.Total, "\n                Products: ").concat(this.Products.toString(), "\n            "));
    }
};
anyType.Print();
//Array of objects:
...
for (var _b = 0, arrayOfObj_1 = arrayOfObj; _b < arrayOfObj_1.length; _b++) {
    var arrayOb = arrayOfObj_1[_b];
    console.log(arrayOb);
}
//Map type
/*
...
*/
var mapType = new Map(); //key can be only number, and value any string 
mapType.set(1, "hello");
mapType.set(2, "Hey");
console.log(mapType.get(1));
console.log(mapType.get(2));
//Date type
var date = new Date(); //takes current date
